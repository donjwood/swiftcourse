...
//  Smashtag
//
//  Created by Donald Wood on 5/17/15.
...
class TweetTableViewController: UITableViewController, UITextFieldDelegate {
    ...
    private struct Constants {
        static let DefaultSearchValue = "#Stanford"
    }
    ...
    var searchText: String? = Constants.DefaultSearchValue {
        didSet{
            ...
            if searchText != nil && searchText != "" {
                recentSearches.addToHistory(searchText!)
            }
        }
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if let mentionsTVC = destination as? MentionsTableViewController{
            //Set correct properties in mention table view controller
