...
class ImageViewController: UIViewController, UIScrollViewDelegate
{
    ...
    private var userDidScrollOrZoom: Bool = false
    ...
    @IBOutlet private weak var scrollView: UIScrollView! {
        didSet {
            ...
            scrollView.maximumZoomScale = 50.0             // required for zooming
        }
    }
    ...
    //Automatically zooms the image to fit the screen until the user zooms themselves
    private func autoZoomToFit() {
        if !userDidScrollOrZoom {
            ...
            if image != nil {
                ...
                scrollView.zoomScale = max(scrollView.bounds.width / image!.size.width, scrollView.bounds.height / image!.size.height)
